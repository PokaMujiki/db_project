select trade_points_halls_amount.point_name as point_name,
       sum(polls_receiptitem.price * polls_receiptitem.amount) / trade_points_halls_amount.halls_amount as profit_div_halls_amount
from polls_receipt
...
order by profit_div_halls_amount desc
